-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.6.1 to 3.5.0
-- generated by tools/build-extension-update-file
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

\echo Use "ALTER extension pgrouting update to '3.5.0'" to load this file. \quit

-------------------------------------
-- remove functions no longer in the 3.5.0 extension
-------------------------------------
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_dijkstra(text,anyarray,anyarray,boolean,boolean,boolean);
DROP FUNCTION IF EXISTS _pgr_dijkstra(text,anyarray,anyarray,boolean,boolean,boolean);

ALTER EXTENSION pgrouting DROP FUNCTION _pgr_gsoc_vrppdtw(text,integer,double precision,double precision,integer);
DROP FUNCTION IF EXISTS _pgr_gsoc_vrppdtw(text,integer,double precision,double precision,integer);

ALTER EXTENSION pgrouting DROP FUNCTION _pgr_makedistancematrix(text);
DROP FUNCTION IF EXISTS _pgr_makedistancematrix(text);

ALTER EXTENSION pgrouting DROP FUNCTION _pgr_unnest_matrix(double precision[]);
DROP FUNCTION IF EXISTS _pgr_unnest_matrix(double precision[]);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_alphashape(text,double precision);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_bdastar(text,bigint,bigint);
DROP FUNCTION IF EXISTS pgr_bdastar(text,bigint,bigint);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_bddijkstra(text,bigint,bigint);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_contractgraph(text,bigint[],integer,bigint[],boolean);
DROP FUNCTION IF EXISTS pgr_contractgraph(text,bigint[],integer,bigint[],boolean);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_dijkstra(text,bigint,bigint);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_endpoint(geometry);
DROP FUNCTION IF EXISTS pgr_endpoint(geometry);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_euclediantsp(text,bigint,bigint,double precision,integer,integer,integer,double precision,double precision,double precision,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_flipedges(geometry[]);
DROP FUNCTION IF EXISTS pgr_flipedges(geometry[]);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_getcolumnname(text,text);
DROP FUNCTION IF EXISTS pgr_getcolumnname(text,text);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_gettablename(text);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_iscolumnindexed(text,text);
DROP FUNCTION IF EXISTS pgr_iscolumnindexed(text,text);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_iscolumnintable(text,text);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_labelgraph(text,text,text,text,text,text);
DROP FUNCTION IF EXISTS pgr_labelgraph(text,text,text,text,text,text);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowboykovkolmogorov(text,anyarray,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,anyarray,anyarray);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowboykovkolmogorov(text,anyarray,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,anyarray,bigint);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowboykovkolmogorov(text,bigint,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,bigint,anyarray);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowboykovkolmogorov(text,bigint,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,bigint,bigint);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowedmondskarp(text,anyarray,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,anyarray,anyarray);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowedmondskarp(text,anyarray,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,anyarray,bigint);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowedmondskarp(text,bigint,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,bigint,anyarray);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowedmondskarp(text,bigint,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,bigint,bigint);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowpushrelabel(text,anyarray,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,anyarray,anyarray);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowpushrelabel(text,anyarray,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,anyarray,bigint);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowpushrelabel(text,bigint,anyarray);
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,bigint,anyarray);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maxflowpushrelabel(text,bigint,bigint);
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,bigint,bigint);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_maximumcardinalitymatching(text,boolean);
DROP FUNCTION IF EXISTS pgr_maximumcardinalitymatching(text,boolean);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_pointsaspolygon(character varying,double precision);
DROP FUNCTION IF EXISTS pgr_pointsaspolygon(character varying,double precision);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_pointstodmatrix(geometry[],integer);
DROP FUNCTION IF EXISTS pgr_pointstodmatrix(geometry[],integer);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_pointstovids(geometry[],text,double precision);
DROP FUNCTION IF EXISTS pgr_pointstovids(geometry[],text,double precision);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_pointtoedgenode(text,geometry,double precision);
DROP FUNCTION IF EXISTS pgr_pointtoedgenode(text,geometry,double precision);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_quote_ident(text);
DROP FUNCTION IF EXISTS pgr_quote_ident(text);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_startpoint(geometry);
DROP FUNCTION IF EXISTS pgr_startpoint(geometry);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_texttopoints(text,integer);
DROP FUNCTION IF EXISTS pgr_texttopoints(text,integer);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_tsp(double precision[],integer,integer);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_versionless(text,text);
DROP FUNCTION IF EXISTS pgr_versionless(text,text);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_vidstodmatrix(integer[],geometry[],text,double precision);
DROP FUNCTION IF EXISTS pgr_vidstodmatrix(integer[],geometry[],text,double precision);

ALTER EXTENSION pgrouting DROP FUNCTION pgr_vidstodmatrix(text,integer[],boolean,boolean,boolean);
...
ALTER EXTENSION pgrouting DROP TYPE pgr_costresult;  DROP TYPE pgr_costresult CASCADE;
ALTER EXTENSION pgrouting DROP TYPE pgr_costresult3; DROP TYPE pgr_costresult3 CASCADE;
ALTER EXTENSION pgrouting DROP TYPE pgr_geomresult;  DROP TYPE pgr_geomresult CASCADE;
...
AND proargnames = '{edges_sql,start_vid,end_vid,directed,seq,path_seq,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,seq,path_seq,node,end_vid,edge,cost,agg_cost}'
WHERE proname = 'pgr_dijkstra'
AND proargnames = '{edges_sql,start_vid,end_vids,directed,seq,path_seq,end_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,seq,path_seq,start_vid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_dijkstra'
AND proargnames = '{edges_sql,start_vids,end_vid,directed,seq,path_seq,start_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,seq,path_seq,start_vid,end_vid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_dijkstra'
AND proargnames = '{edges_sql,start_vids,end_vids,directed,seq,path_seq,start_vid,end_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_dijkstracost';
    
UPDATE pg_proc SET
proargnames = '{"","",directed,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_dijkstracostmatrix'
AND proargnames = '{edges_sql,vids,directed,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","",directed,strict,u_turn_on_edge,seq,path_id,path_seq,start_vid,end_vid,node,edge,cost,agg_cost,route_agg_cost}'
WHERE proname = 'pgr_dijkstravia'
AND proargnames = '{edges_sql,via_vertices,directed,strict,u_turn_on_edge,seq,path_id,path_seq,start_vid,end_vid,node,edge,cost,agg_cost,route_agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"",directed,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_johnson'
AND proargnames = '{edges_sql,directed,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"",directed,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_floydwarshall'
AND proargnames = '{edges_sql,directed,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,heuristic,factor,epsilon,seq,path_seq,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_astar'
AND proargnames = '{edges_sql,start_vid,end_vid,directed,heuristic,factor,epsilon,seq,path_seq,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,heuristic,factor,epsilon,seq,path_seq,end_vid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_astar'
AND proargnames = '{edges_sql,start_vid,end_vids,directed,heuristic,factor,epsilon,seq,path_seq,end_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,heuristic,factor,epsilon,seq,path_seq,start_vid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_astar'
AND proargnames = '{edges_sql,start_vids,end_vid,directed,heuristic,factor,epsilon,seq,path_seq,start_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,heuristic,factor,epsilon,seq,path_seq,start_vid,end_vid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_astar'
AND proargnames = '{edges_sql,start_vids,end_vids,directed,heuristic,factor,epsilon,seq,path_seq,start_vid,end_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,heuristic,factor,epsilon,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_astarcost';
    
UPDATE pg_proc SET
proargnames = '{"","",directed,heuristic,factor,epsilon,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_astarcostmatrix'
AND proargnames = '{edges_sql,vids,directed,heuristic,factor,epsilon,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,details,seq,path_seq,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpoints'
AND proargnames = '{edges_sql,points_sql,start_pid,end_pid,directed,driving_side,details,seq,path_seq,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,details,seq,path_seq,end_pid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpoints'
AND proargnames = '{edges_sql,points_sql,start_pid,end_pids,directed,driving_side,details,seq,path_seq,end_pid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,details,seq,path_seq,start_pid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpoints'
AND proargnames = '{edges_sql,points_sql,start_pids,end_pid,directed,driving_side,details,seq,path_seq,start_pid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,details,seq,path_seq,start_pid,end_pid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpoints'
AND proargnames = '{edges_sql,points_sql,start_pids,end_pids,directed,driving_side,details,seq,path_seq,start_pid,end_pid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,start_pid,end_pid,agg_cost}'
WHERE proname = 'pgr_withpointscost';
    
UPDATE pg_proc SET
proargnames = '{"","","",directed,driving_side,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_withpointscostmatrix'
AND proargnames = '{edges_sql,points_sql,pids,directed,driving_side,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,details,equicost,seq,start_vid,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpointsdd'
AND proargnames = '{edges_sql,points_sql,start_pid,distance,directed,driving_side,details,equicost,seq,start_vid,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,driving_side,details,seq,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpointsdd'
AND proargnames = '{edges_sql,points_sql,start_pid,distance,directed,driving_side,details,seq,node,edge,cost,agg_cost}';
...
UPDATE pg_proc SET
proargnames = '{"","","",directed,equicost,seq,from_v,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_drivingdistance'
AND proargnames = '{edges_sql,start_vids,distance,directed,equicost,seq,from_v,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","",directed,heap_paths,seq,path_id,path_seq,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_ksp'
AND proargnames = '{edges_sql,start_vid,end_vid,k,directed,heap_paths,seq,path_id,path_seq,node,edge,cost,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","","","","",directed,heap_paths,driving_side,details,seq,path_id,path_seq,node,edge,cost,agg_cost}'
WHERE proname = 'pgr_withpointsksp'
AND proargnames = '{edges_sql,points_sql,start_pid,end_pid,k,directed,heap_paths,driving_side,details,seq,path_id,path_seq,node,edge,cost,agg_cost}';
    
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_bddijkstra(text,anyarray,anyarray,boolean,boolean);
DROP FUNCTION IF EXISTS _pgr_bddijkstra(text,anyarray,anyarray,boolean,boolean);
...
UPDATE pg_proc SET
proargnames = '{"","","",directed,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_bddijkstracost';
    
UPDATE pg_proc SET
proargnames = '{"","",directed,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_bddijkstracostmatrix'
AND proargnames = '{edges_sql,vids,directed,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"","",directed,heuristic,factor,epsilon,start_vid,end_vid,agg_cost}'
WHERE proname = 'pgr_bdastarcostmatrix'
AND proargnames = '{edges_sql,vids,directed,heuristic,factor,epsilon,start_vid,end_vid,agg_cost}';
    
UPDATE pg_proc SET
proargnames = '{"",directed,seq,edge,source,target}'
WHERE proname = 'pgr_maxcardinalitymatch'
AND proargnames = '{edges_sql,directed,seq,edge,source,target}';
    
UPDATE pg_proc SET
proargnames = '{"","",""}'
WHERE proname = 'pgr_maxflow'
AND proargnames = '{edges_sql,source_vertices,sink_vertices}';
    
UPDATE pg_proc SET
proargnames = '{"",start_id,end_id,max_processing_time,tries_per_temperature,max_changes_per_temperature,max_consecutive_non_changes,initial_temperature,final_temperature,cooling_factor,randomize,seq,node,cost,agg_cost}'
WHERE proname = 'pgr_tsp'
AND proargnames = '{matrix_row_sql,start_id,end_id,max_processing_time,tries_per_temperature,max_changes_per_temperature,max_consecutive_non_changes,initial_temperature,final_temperature,cooling_factor,randomize,seq,node,cost,agg_cost}';
    
ALTER EXTENSION pgrouting DROP FUNCTION pgr_connectedcomponents(text);
DROP FUNCTION IF EXISTS pgr_connectedcomponents(text);



ALTER EXTENSION pgrouting DROP FUNCTION pgr_strongcomponents(text);
DROP FUNCTION IF EXISTS pgr_strongcomponents(text);



ALTER EXTENSION pgrouting DROP FUNCTION pgr_biconnectedcomponents(text);
DROP FUNCTION IF EXISTS pgr_biconnectedcomponents(text);



ALTER EXTENSION pgrouting DROP FUNCTION pgr_articulationpoints(text);
DROP FUNCTION IF EXISTS pgr_articulationpoints(text);



ALTER EXTENSION pgrouting DROP FUNCTION pgr_bridges(text);
DROP FUNCTION IF EXISTS pgr_bridges(text);



UPDATE pg_proc SET
proargnames = '{"","","","",oid,opos,vid,tarrival,tdepart}'
WHERE proname = 'pgr_vrponedepot'
AND proargnames = '{order_sql,vehicle_sql,cost_sql,depot_id,oid,opos,vid,tarrival,tdepart}';
    
UPDATE pg_proc SET
proargnames = '{"","",id,the_geom,table_ending,rows_where,outall}'
WHERE proname = 'pgr_nodenetwork'
AND proargnames = '{edge_table,tolerance,id,the_geom,table_ending,rows_where,outall}';
    
UPDATE pg_proc SET
proargnames = '{"",the_geom,source,target,rows_where}'
WHERE proname = 'pgr_createverticestable'
AND proargnames = '{edge_table,the_geom,source,target,rows_where}';
    
UPDATE pg_proc SET
proargnames = '{"","",the_geom,id,source,target,rows_where,clean}'
WHERE proname = 'pgr_createtopology'
AND proargnames = '{edge_table,tolerance,the_geom,id,source,target,rows_where,clean}';
    
UPDATE pg_proc SET
proargnames = '{"","",the_geom,id,source,target,rows_where}'
WHERE proname = 'pgr_analyzegraph'
AND proargnames = '{edge_table,tolerance,the_geom,id,source,target,rows_where}';
    
UPDATE pg_proc SET
proargnames = '{"","","","","",two_way_if_null,oneway,source,target}'
WHERE proname = 'pgr_analyzeoneway'
AND proargnames = '{edge_table,s_in_rules,s_out_rules,t_in_rules,t_out_rules,two_way_if_null,oneway,source,target}';
