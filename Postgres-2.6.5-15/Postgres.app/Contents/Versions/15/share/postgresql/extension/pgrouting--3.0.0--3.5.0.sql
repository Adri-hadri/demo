-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 3.0.0 to 3.5.0
...
UPDATE pg_proc SET
proallargtypes = '{25,20,20,20}'
WHERE proname = '_pgr_strongcomponents'
AND proallargtypes = '{25,23,20,20}';
    
UPDATE pg_proc SET
proallargtypes = '{25,20,20,20}'
WHERE proname = 'pgr_strongcomponents'
AND proallargtypes = '{25,23,20,20}';
    
UPDATE pg_proc SET
proallargtypes = '{25,20,20,20}'
WHERE proname = '_pgr_biconnectedcomponents'
AND proallargtypes = '{25,23,20,20}';
    
UPDATE pg_proc SET
proallargtypes = '{25,20,20,20}'
WHERE proname = 'pgr_biconnectedcomponents'
AND proallargtypes = '{25,23,20,20}';
    
UPDATE pg_proc SET
proargnames = '{"",seq,edge,cost,mincut}'
WHERE proname = 'pgr_stoerwagner'
AND proargnames = '{edges_sql,seq,edge,cost,mincut}';
    
UPDATE pg_proc SET
proargnames = '{"",seq,sorted_v}'
WHERE proname = 'pgr_topologicalsort'
AND proargnames = '{edges_sql,seq,sorted_v}';
    
UPDATE pg_proc SET
proargnames = '{"",seq,vid,target_array}'
WHERE proname = 'pgr_transitiveclosure'
AND proargnames = '{edges_sql,seq,vid,target_array}';
